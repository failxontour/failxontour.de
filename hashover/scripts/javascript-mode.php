...
//	echo jsAddSlashes('HashOver Comments &middot;\n');
	if (!empty($show_cmt)) echo jsAddSlashes('<a rel="nofollow" href="http://' . $domain . $root_dir . 'comments.php?rss=' . $page_url . '" target="_blank">RSS Feed</a>');
//	echo jsAddSlashes('<a rel="nofollow" href="https://github.com/jacobwb/hashover" target="_blank">Source Code</a> &middot;\n');
//	echo jsAddSlashes('<a rel="nofollow" href="http://' . $domain . $root_dir . 'comments.php" target="_blank">JavaScript</a> &middot;\n');
//	echo jsAddSlashes('<a rel="nofollow" href="https://github.com/jacobwb/hashover/releases	" target="_blank">ChangeLog</a> &middot;\n');
