...
!(function (e, t, n) {
  ...
  function i(e) {
    ...
    Modernizr._config.enableClasses &&
      ((t += " " + n + e.join(" " + n)),
      T ? (N.className.baseVal = t) : (N.className = t));
  }
  function a() {
  ...
  function u(e, t) {
    if ("object" == typeof e) for (var n in e) A(e, n) && u(n, e[n]);
    else {
      e = e.toLowerCase();
      var r = e.split("."),
        o = Modernizr[r[0]];
  ...
  function d(e, n, r, o) {
    ...
    return (
      ...
      (s = n(d, e)),
      p.fake
        ? (p.parentNode.removeChild(p), (N.style.overflow = u), N.offsetHeight)
  ...
  function h(e, t, o, i) {
    ...
    for (
      ...
      ((c = !0), (L.modElem = a(g.shift())), (L.style = L.modElem.style));
    for (p = e.length, d = 0; p > d; d++)
      if (
        ...
        if (L.style[h] != v) return (l(), "pfx" == t ? h : !0);
      }
    return (l(), !1);
  }
  function v(e, t) {
        ...
        return (
          (o = r.cache[e]
            ...
            : C.test(e)
              ...
              : r.createElem(e)),
          !o.canHaveChildren || S.test(e) || o.tagUrn
            ? o
  ...
  _.prefixedCSSValue = P;
  var z = _._config.usePrefixes ? E.split(" ") : [];
  _._cssomPrefixes = z;
  var k = function (t) {
    var r,
      o = w.length,
  ...
  ((_.testAllProps = S), o(), i(C), delete _.addTest, delete _.addAsyncTest);
